---
title: "typescript-language-server/typescript-language-server: Unofficial TypeScript & JavaScript Language Server"
description: "Unofficial TypeScript & JavaScript Language Server - typescript-language-server/typescript-language-server"
source_url: "https://github.com/typescript-language-server/typescript-language-server"
...
> Source: [typescript-language-server/typescript-language-server: Unofficial TypeScript & JavaScript Language Server](https://github.com/typescript-language-server/typescript-language-server)
> Clipped: 2026-08-04
...
Originally based on concepts and ideas from [https://github.com/prabirshrestha/typescript-language-server](https://github.com/prabirshrestha/typescript-language-server) and maintained by [TypeFox](https://typefox.io/). Currently maintained by a [community of contributors](https://github.com/typescript-language-server/typescript-language-server/graphs/contributors) like you.
...
See [configuration documentation](https://github.com/typescript-language-server/typescript-language-server/blob/master/docs/configuration.md).
...
Code lenses can be enabled using the `implementationsCodeLens` and `referencesCodeLens` [workspace configuration options](https://github.com/typescript-language-server/typescript-language-server/blob/master/docs/configuration.md/#workspacedidchangeconfiguration).
