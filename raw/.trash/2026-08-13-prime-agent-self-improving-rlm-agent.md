...
author: "Seth Karten, Alex L. Zhang, Kevin Thomas, Sebastian Müller, Prime Intellect Team"
...
> Author: Seth Karten, Alex L. Zhang, Kevin Thomas, Sebastian Müller, Prime Intellect Team
> Published: Aug 05th, 2026 · Research
> Clipped: 2026-08-13
...
*(Diagram: Prime Agent's Architecture — RLM and Continual Harness are the two core abstractions; sub-agent CRUD plus Agent2Agent messaging compose them into orchestration.)*
...
*(Chart: ARC-AGI-3 — left: test-time compute scaling, score vs. output tokens per game; right: cost scaling, score vs. estimated API cost.)*
...
| Eval | Description | GLM-5.2 Prime-Agent | GLM-5.2 Pi-mono (w/ sub-agents) | Opus 5 Prime-Agent | Opus 5 Claude Code | GPT-5.6 Sol Prime-Agent | GPT-5.6 Sol Codex |
|---|---|---|---|---|---|---|---|
...
*(Image caption: Prime Agent using subagents and programmatic tool calling to cheat on Factorio by teleporting resources directly into machines.)*
...
Seth Karten, Alex L. Zhang, Kevin Thomas, Sebastian Müller, Prime Intellect Team

---

### Related posts (linked from this article)

- Multi-Agent Systems in PRIME-RL — The Prime Intellect RL stack expands from training individual agents to multi-agent systems. You can now program arbitrary interactions between agents, choose which roles learn, and assign credit across the complete interaction.
- Scaling Agentic RL: 365,000+ Environments for SWE, Terminal, and Search — We ship first-party integrations for 23 agentic tasksets behind one taskset API - ~365,000 software engineering, terminal, and search tasks, validated and ready for evals and RL training on Prime Intellect infrastructure.
- verifiers v1: Decomposing Tasksets and Harnesses for Agentic RL & Evaluations — We are launching verifiers 0.2.0, previewing a rewritten core that decomposes environments into composable tasksets, harnesses, and runtimes for modern agentic training and evaluations.
