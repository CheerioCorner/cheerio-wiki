---
title: "OmniSharp/omnisharp-roslyn: OmniSharp server (HTTP, STDIO) based on Roslyn workspaces"
description: "OmniSharp server (HTTP, STDIO) based on Roslyn workspaces - OmniSharp/omnisharp-roslyn"
source_url: "https://github.com/OmniSharp/omnisharp-roslyn"
...
> Source: [OmniSharp/omnisharp-roslyn: OmniSharp server (HTTP, STDIO) based on Roslyn workspaces](https://github.com/OmniSharp/omnisharp-roslyn)
> Clipped: 2026-08-04
...
In addition, if you need the HTTP interface and you want to run on Linux, you'll also need to make sure that you have [libuv](http://libuv.org/) installed. See also [#1202 (comment)](https://github.com/OmniSharp/omnisharp-roslyn/issues/1202#issuecomment-421543905).
