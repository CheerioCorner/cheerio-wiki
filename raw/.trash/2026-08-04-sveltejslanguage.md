---
title: "sveltejs/language-tools: The Svelte Language Server, and official extensions which use it"
description: "The Svelte Language Server, and official extensions which use it - sveltejs/language-tools"
source_url: "https://github.com/sveltejs/language-tools"
...
tags:
  ...
  - "web-clip"
---
# sveltejs/language-tools: The Svelte Language Server, and official extensions which use it

> Source: [sveltejs/language-tools: The Svelte Language Server, and official extensions which use it](https://github.com/sveltejs/language-tools)
> Clipped: 2026-08-04

[![Cybernetically enhanced web apps: Svelte](https://user-images.githubusercontent.com/49038/76711598-f0b39180-66e7-11ea-9501-37f6e1edf8a6.png)](https://svelte.dev/)
...
Contributions are encouraged and always welcome. [Read the contribution guide for more info](https://github.com/sveltejs/language-tools/blob/master/CONTRIBUTING.md) and help us out!
