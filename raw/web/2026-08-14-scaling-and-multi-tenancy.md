...
description: "Design your Copilot SDK deployment to serve multiple users, handle concurrent sessions, and scale horizontally across infrastructure. This guide covers session isolation patterns, scaling topologies, and production best practices."
source_url: "https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling"
...
> Source: [Scaling and multi-tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling)
> Clipped: 2026-08-14

For SDK-level options and patterns, see [Multi-tenancy and server deployments](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy).
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-71679/mw-1440/images/help/copilot/copilot-sdk/setup-scaling-diagram-0.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-57050/mw-1440/images/help/copilot/copilot-sdk/setup-scaling-diagram-1.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-54130/mw-1440/images/help/copilot/copilot-sdk/setup-scaling-diagram-2.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-56036/mw-1440/images/help/copilot/copilot-sdk/setup-scaling-diagram-3.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-62779/mw-1440/images/help/copilot/copilot-sdk/setup-scaling-diagram-4.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-45973/mw-1440/images/help/copilot/copilot-sdk/setup-scaling-diagram-5.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-51975/mw-1440/images/help/copilot/copilot-sdk/setup-scaling-diagram-6.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-47952/mw-1440/images/help/copilot/copilot-sdk/setup-scaling-diagram-7.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-55307/mw-1440/images/help/copilot/copilot-sdk/setup-scaling-diagram-8.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-20472/mw-1440/images/help/copilot/copilot-sdk/setup-scaling-diagram-9.webp)
...
- **[Session resume and persistence](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/session-persistence)**: Deep dive on resumable sessions
- **[Backend services setup](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services)**: Core server-side setup
- **[GitHub OAuth setup](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth)**: Multi-user authentication
- **[BYOK (bring your own key)](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok)**: Use your own model provider