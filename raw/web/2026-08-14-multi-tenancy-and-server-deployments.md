...
> Source: [Multi-tenancy and server deployments](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy)
> Clipped: 2026-08-14
...
This guide is a sister to [Scaling and multi-tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling). Use that guide for topology, load-balancing, and storage patterns. Use this guide for SDK-level options and runtime isolation choices.
...
| --- | --- | --- |
| Pattern 1: isolated CLI per user | You need the strongest isolation boundary or separate process credentials per user. | Strong isolation; higher resource cost. See [Scaling and multi-tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling). |
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-54403/mw-1440/images/help/copilot/copilot-sdk/setup-multi-tenancy-diagram-0.webp)
...
- [Scaling and multi-tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling): deployment topologies, storage patterns, and isolation comparisons
- [Backend services setup](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services): running the runtime in headless server mode
- [BYOK (bring your own key)](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok): using your own model provider credentials
...
- [Session resume and persistence](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/session-persistence): managing resumable session state
