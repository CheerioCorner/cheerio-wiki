---
title: morphir-dotnet/AGENTS.md at main
description: Dotnet tooling for Morphir. Contribute to finos/morphir-dotnet development by creating an account on GitHub.
source_url: https://github.com/finos/morphir-dotnet/blob/main/AGENTS.md
...
tags:
  ...
  - web-clip
---
# morphir-dotnet/AGENTS.md at main

> Source: [morphir-dotnet/AGENTS.md at main](https://github.com/finos/morphir-dotnet/blob/main/AGENTS.md)
> Clipped: 2026-08-02

## AGENTS.md

Guidance for AI coding agents contributing to finos/morphir-dotnet (a.NET binding for the Morphir ecosystem). Produce correct, minimal, and well‑tested changes aligned with Morphir IR and tooling.

## Quick Navigation

- **This file (AGENTS.md)**: Primary guidance for all AI agents
- **Specialized Topics**: See [.agents/](https://github.com/finos/morphir-dotnet/blob/main/.agents) directory for domain-specific guides
	- [Skills Reference](https://github.com/finos/morphir-dotnet/blob/main/.agents/skills-reference.md) - QA Tester, AOT Guru, Release Manager, Technical Writer
		- [Capabilities Matrix](https://github.com/finos/morphir-dotnet/blob/main/.agents/capabilities-matrix.md) - Cross-agent feature availability
		- [QA Testing](https://github.com/finos/morphir-dotnet/blob/main/.agents/qa-testing.md) - Test plans, playbooks, scripts
		- [AOT Optimization](https://github.com/finos/morphir-dotnet/blob/main/.agents/aot-optimization.md) - Trimming, AOT guidance
- **Agent-Specific Instructions**:
	- **Claude Code**: [CLAUDE.md](https://github.com/finos/morphir-dotnet/blob/main/CLAUDE.md) + [.claude/skills/](https://github.com/finos/morphir-dotnet/blob/main/.claude/skills)
		- **GitHub Copilot**: [.github/copilot-instructions.md](https://github.com/finos/morphir-dotnet/blob/main/.github/copilot-instructions.md)
		- **Cursor**: [.cursorrules](https://github.com/finos/morphir-dotnet/blob/main/.cursorrules)
		- **Windsurf**: [.windsurf/rules.md](https://github.com/finos/morphir-dotnet/blob/main/.windsurf/rules.md) (if present)
		- **Aider**: [.aider.conf.yml](https://github.com/finos/morphir-dotnet/blob/main/.aider.conf.yml) (if present)
- **Documentation**: See [docs/](https://github.com/finos/morphir-dotnet/blob/main/docs) for user-facing docs

## Project Links

- Morphir: [https://morphir.finos.org/](https://morphir.finos.org/)
- morphir (core/tooling): [https://github.com/finos/morphir](https://github.com/finos/morphir)
- morphir-elm: [https://github.com/finos/morphir-elm](https://github.com/finos/morphir-elm)
- morphir-dotnet (this repo): [https://github.com/finos/morphir-dotnet](https://github.com/finos/morphir-dotnet)

## 1) Project Overview

Purpose

- Provide.NET bindings, libraries, codecs, and tooling interoperable with the Morphir IR (intermediate representation) and developer workflows.
...
- See [F# Coding Guide](https://github.com/finos/morphir-dotnet/blob/main/docs/contributing/fsharp-coding-guide.md) for comprehensive F# standards
- **Computation Expressions for DSLs**: Use CustomOperations for query-style syntax, Yield/Delay/Run for compositional nesting, or combine both for flexible hybrid DSLs (see [CE Guide](https://github.com/finos/morphir-dotnet/blob/main/docs/contributing/fsharp-coding-guide.md#computation-expressions-and-dsls))
...
- See [AOT/Trimming Guide](https://github.com/finos/morphir-dotnet/blob/main/docs/contributing/aot-trimming-guide.md) for comprehensive AOT/trimming guidance
...
Rationale: CLI tools that write to stdout break scriptability and JSON parsing. Users expect to pipe command output (e.g., `morphir ir verify file.json --json | jq`) without log noise contaminating the structured output. Following Unix philosophy: stdout = data, stderr = diagnostics.
...
- **DSL Builders**: Use F# Computation Expressions for clean IR construction syntax (see [Morphir IR DSL](https://github.com/finos/morphir-dotnet/blob/main/src/Morphir.Models/IR/Classic/DSL) and [CE Guide](https://github.com/finos/morphir-dotnet/blob/main/docs/contributing/fsharp-coding-guide.md#computation-expressions-and-dsls))
...
- **CRITICAL**: **Do NOT include `Co-Authored-By: Claude` or any AI assistant as co-author on commits.** Our CLA does NOT support AI assistants as co-authors. Violations will block PR merges. See [Commit Messages section](#commit-messages) for details and remediation steps. Note: GitHub Copilot may be listed as co-author when it is an actual co-author.
	- **If you accidentally included Claude as a co-author**, use the [remove-claude-coauthor.fsx](https://github.com/finos/morphir-dotnet/blob/main/scripts/remove-claude-coauthor.fsx) script to fix it:
		```
		# Preview changes
		...
		```
		- See [scripts/README.md](https://github.com/finos/morphir-dotnet/blob/main/scripts/README.md) for complete usage and options.
- PR checklist:
...
**DO NOT include `Co-Authored-By: Claude` or any AI assistant as a co-author in commits.**
...
3. **Use automated script** (recommended):
	...
	dotnet fsi scripts/remove-claude-coauthor.fsx --commits 5 --yes
	```
	See [scripts/README.md](https://github.com/finos/morphir-dotnet/blob/main/scripts/README.md) for complete documentation.
...
- If uncertain about Morphir compatibility, add a TODO with a question and take the conservative path.

## 18) Specialized Guidance

This repository provides specialized, domain-specific guidance in the [.agents/](https://github.com/finos/morphir-dotnet/blob/main/.agents) directory:

### Skills Reference

**NEW**: [Skills Reference](https://github.com/finos/morphir-dotnet/blob/main/.agents/skills-reference.md) - Comprehensive documentation of all expert skills (gurus):
...
**NEW**: [Capabilities Matrix](https://github.com/finos/morphir-dotnet/blob/main/.agents/capabilities-matrix.md) - Cross-agent feature availability:
...
- **[QA Testing](https://github.com/finos/morphir-dotnet/blob/main/.agents/qa-testing.md)** - Comprehensive QA guidance
	- Test plan templates
...
- **[AOT Optimization](https://github.com/finos/morphir-dotnet/blob/main/.agents/aot-optimization.md)** - Native AOT, trimming, and size optimization
...
- See [.agents/skills-reference.md](https://github.com/finos/morphir-dotnet/blob/main/.agents/skills-reference.md#cross-platform-skill-invocation) for comprehensive invocation patterns for each platform
- See [capabilities-matrix.md](https://github.com/finos/morphir-dotnet/blob/main/.agents/capabilities-matrix.md) for feature comparison table
...
- **Discover skills**: Ask "What skills are available in this project?" → Copilot should read [.agents/skills-reference.md](https://github.com/finos/morphir-dotnet/blob/main/.agents/skills-reference.md) and list QA Tester, AOT Guru, Release Manager, Technical Writer with links.
...
See the dedicated Copilot test plan: [docs/content/contributing/qa/copilot-skill-emulation-test-plan.md](https://github.com/finos/morphir-dotnet/blob/main/docs/content/contributing/qa/copilot-skill-emulation-test-plan.md).
...
See [.agents/README.md](https://github.com/finos/morphir-dotnet/blob/main/.agents/README.md) for navigation and contribution guidelines.
...
- [.agents/](https://github.com/finos/morphir-dotnet/blob/main/.agents) - Specialized topic guides
- [CLAUDE.md](https://github.com/finos/morphir-dotnet/blob/main/CLAUDE.md) - Claude Code-specific features
- [README.md](https://github.com/finos/morphir-dotnet/blob/main/README.md) - Project README for humans

### Testing Resources

- [Phase 1 Test Plan](https://github.com/finos/morphir-dotnet/blob/main/docs/content/contributing/qa/phase-1-test-plan.md) - Example comprehensive test plan
- [QA Testing Guide](https://github.com/finos/morphir-dotnet/blob/main/.agents/qa-testing.md) - Cross-agent QA practices
- [QA Skill](https://github.com/finos/morphir-dotnet/blob/main/.claude/skills/qa-tester) - Claude Code QA automation

### AOT and Optimization Resources

- [AOT/Trimming Guide](https://github.com/finos/morphir-dotnet/blob/main/docs/contributing/aot-trimming-guide.md) - User-facing AOT documentation
- [AOT Optimization Guide](https://github.com/finos/morphir-dotnet/blob/main/.agents/aot-optimization.md) - Agent-specific AOT guidance
- [AOT Guru Skill](https://github.com/finos/morphir-dotnet/blob/main/.claude/skills/aot-guru) - Claude Code AOT diagnostics and optimization
- [F# Coding Guide](https://github.com/finos/morphir-dotnet/blob/main/docs/contributing/fsharp-coding-guide.md) - Includes F# AOT patterns