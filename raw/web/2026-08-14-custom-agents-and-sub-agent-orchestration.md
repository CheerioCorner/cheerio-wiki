...
description: "Define specialized agents with scoped tools and prompts, then let Copilot orchestrate them as sub-agents within a single session. For dispatching multiple sub-agents in parallel, see Fleet mode."
source_url: "https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/custom-agents"
...
> Source: [Custom agents and sub-agent orchestration](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/custom-agents)
> Clipped: 2026-08-14
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-62272/mw-1440/images/help/copilot/copilot-sdk/features-custom-agents-diagram-0.webp)
