...
> Source: [Build with Agent Skills](https://modelcontextprotocol.io/docs/2026-07-28/develop/build-with-agent-skills)
> Clipped: 2026-08-22
...
- **User interaction needs** — plain text results, structured input via [elicitation](https://modelcontextprotocol.io/specification/2026-07-28/client/elicitation), or rich UI widgets
...
**Local [stdio](https://modelcontextprotocol.io/specification/2026-07-28/basic/transports/stdio)** remains available for prototyping, with a noted upgrade path to MCPB when you’re ready to distribute.
