...
description: "This document resumes the causes of slowness when using a Redis database. Discover the troubleshooting techniques to identify the root cause of latency."
source_url: "https://redis.io/faq/doc/1mebipyp1e/performance-tuning-best-practices"
...
> Source: [Performance Tuning Best Practices](https://redis.io/faq/doc/1mebipyp1e/performance-tuning-best-practices)
> Clipped: 2026-08-03

[Redis Software](https://redis.io/faq/public?cat=1cmzkcxg2e)

[Redis Cloud](https://redis.io/faq/public?cat=1x5z2h4q4d)

[Redis Open Source](https://redis.io/faq/public?cat=2o9qogwfm6)

[performance](https://redis.io/faq/public?tag=performance)

## Question

In this article, you can find best practices for operating a Redis Software database. Some recommendations are also good for a Redis Community deployment, especially when dealing with the suitable data types and commands, keeping an eye on command complexity.
...
Redis Software keeps connections open forever unless clients close them or don't reply to TCP keep-alive messages. Idle connections that do not answer keepalives for 5 consecutive minutes are closed: Redis Software assumes that clients closed their connections. Verifying the number of active connections is possible using the `CLIENT LIST` command.
...
- [How can I perform massive key deletion in Redis without impacting performance?](https://redis.io/faq/doc/12ei3i4gvo/how-can-i-perform-massive-key-deletion-in-redis-without-impacting-performance)
...
- [How to Troubleshoot Latency Issues?](https://redis.io/faq/doc/2no7qfbtpf/how-to-troubleshoot-latency-issues)
- [What needs to be checked before resharding a Redis Software database?](https://redis.io/faq/doc/2aur5jkvx8/what-needs-to-be-checked-before-resharding-a-redis-software-database)
- [Is maxmemory the Maximum Value of Used Memory?](https://redis.io/faq/doc/1jbxid5qq7/is-maxmemory-the-maximum-value-of-used-memory)