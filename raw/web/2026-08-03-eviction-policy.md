...
source_url: "https://redis.io/docs/latest/operate/rs/databases/memory-performance/eviction-policy/"
...
> Source: [Eviction policy](https://redis.io/docs/latest/operate/rs/databases/memory-performance/eviction-policy/)
> Clipped: 2026-08-03
...
The default policy for [Active-Active databases](https://redis.io/docs/latest/operate/rs/databases/active-active/) is *noeviction* policy.
...
For larger databases, consider using [Redis Flex or Auto Tiering](https://redis.io/docs/latest/operate/rs/databases/flash/) .
