...
description: "Run the Copilot SDK in server-side applications—APIs, web backends, microservices, and background workers. The CLI runs as a headless server that your backend code connects to over the network."
source_url: "https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services"
...
> Source: [Backend services setup](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/backend-services)
> Clipped: 2026-08-14
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-67783/mw-1440/images/help/copilot/copilot-sdk/setup-backend-services-diagram-0.webp)
...
For multi-user server mode, configure SDK clients with `mode: "empty"`, pass user credentials per session, and explicitly allow tools for each session. See [Multi-tenancy and server deployments](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy) for the full pattern.

## Architecture: auto-managed vs. external CLI

![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-53720/mw-1440/images/help/copilot/copilot-sdk/setup-backend-services-diagram-1.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-17518/mw-1440/images/help/copilot/copilot-sdk/setup-backend-services-diagram-2.webp)
...
Pass individual user tokens when creating sessions. See [GitHub OAuth setup](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth) for the full flow.
...
Use your own API keys for the model provider. See [BYOK (bring your own key)](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok) for details.
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-45428/mw-1440/images/help/copilot/copilot-sdk/setup-backend-services-diagram-3.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-46360/mw-1440/images/help/copilot/copilot-sdk/setup-backend-services-diagram-4.webp)
...
| Limitation | Details |
| --- | --- |
| **Single CLI server = single point of failure** | See [Scaling and multi-tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling) for HA patterns |
...
| Need | Next Guide |
| --- | --- |
| Multiple CLI servers / high availability | [Scaling and multi-tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling) |
| SDK isolation for concurrent users | [Multi-tenancy and server deployments](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy) |
| GitHub account auth for users | [GitHub OAuth setup](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth) |
| Your own model keys | [BYOK (bring your own key)](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/byok) |

## Next steps

- **[Multi-tenancy and server deployments](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy)**: Configure SDK isolation for concurrent users
- **[Scaling and multi-tenancy](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/scaling)**: Handle more users, add redundancy
...
- **[GitHub OAuth setup](https://docs.github.com/en/copilot/how-tos/copilot-sdk/setup/github-oauth)**: Add user authentication