...
> Source: [MCP Registry Aggregators](https://modelcontextprotocol.io/registry/registry-aggregators)
> Clipped: 2026-08-22
...
The `"deleted"` status typically indicates that a server has violated our permissive [moderation policy](https://modelcontextprotocol.io/registry/moderation-policy), suggesting the server might be spam, malware, or illegal. Aggregators may prefer to remove these servers from their index.
