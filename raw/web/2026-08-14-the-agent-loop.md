...
description: "How the Copilot CLI processes a user message end-to-end: from prompt to session.idle."
source_url: "https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/agent-loop"
...
> Source: [The agent loop](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/agent-loop)
> Clipped: 2026-08-14

## Architecture

![Diagram: Graph diagram showing the described process.](https://docs.github.com/assets/cb-33666/mw-1440/images/help/copilot/copilot-sdk/features-agent-loop-diagram-0.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-76669/mw-1440/images/help/copilot/copilot-sdk/features-agent-loop-diagram-1.webp)
...
![Diagram: Flowchart showing the described process.](https://docs.github.com/assets/cb-69649/mw-1440/images/help/copilot/copilot-sdk/features-agent-loop-diagram-2.webp)
...
## session.idle vs session.task\_complete
...
### Autopilot mode: the CLI nudges for task\_complete
...
### Why task\_complete might not appear
...
- [Streaming session events](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/streaming-events): Full field-level reference for every event type
- [Session resume and persistence](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/session-persistence): How sessions are saved and resumed
- [Working with hooks](https://docs.github.com/en/copilot/how-tos/copilot-sdk/features/hooks): Intercepting events in the loop (permissions, tools)