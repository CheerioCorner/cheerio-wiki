---
title: "GitHub - langchain-ai/openwiki: OpenWiki is a CLI that writes and maintains agent documentation for your codebase. · GitHub"
type: raw-web
created: 2026-08-20
url: "https://github.com/langchain-ai/openwiki"
---

# GitHub - langchain-ai/openwiki: OpenWiki is a CLI that writes and maintains agent documentation for your codebase. · GitHub
...
initial-path="/langchain-ai/openwiki"
...
main                 Branches        Tags                         Go to file          Code         Open more actions menu           Latest commit         History       290 Commits              290 Commits       Folders and files      Name    Name     Last commit message      Last commit date             .changeset            .changeset                          .claude            .claude                          .github            .github                          evals            evals                          examples            examples                          openwiki            openwiki                          scripts            scripts                          skills            skills                          src            src                          static            static                          test            test                          .gitignore            .gitignore                          .prettierignore            .prettierignore                          AGENTS.md            AGENTS.md                          CHANGELOG.md            CHANGELOG.md                          CLAUDE.md            CLAUDE.md                          CONTRIBUTING.md            CONTRIBUTING.md                          DEVELOPMENT.md            DEVELOPMENT.md                          LICENSE            LICENSE                          README.md            README.md                          eslint.config.js            eslint.config.js                          package.json            package.json                          pnpm-lock.yaml            pnpm-lock.yaml                          pnpm-workspace.yaml            pnpm-workspace.yaml                          tsconfig.client.json            tsconfig.client.json                          tsconfig.eslint.json            tsconfig.eslint.json                          tsconfig.json            tsconfig.json                          vitest.config.ts            vitest.config.ts                       View all files           Repository files navigation
...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="openwiki auth notion        # run a local browser OAuth flow for a provider

openwiki ingest all         # run every configured source

openwiki ingest web-search  # run one connector's sources"> openwiki auth notion          #  run a local browser OAuth flow for a provider
...
Tip  By default OpenWiki runs a lightweight, zero-dependency check that catches common breakages. For authoritative validation that matches exactly what GitHub renders, install the Mermaid parser wherever you run OpenWiki (for example in your scheduled workflow), and no broken diagram will ship:
...
Browser sign-in, uses your ChatGPT plan
...
OpenAI-compatible  (LiteLLM, Ollama, LM Studio, gateways)
...
Select  GitHub Copilot  during  openwiki --init . If you have an active  GitHub CLI  session, OpenWiki detects it and offers to reuse it. Otherwise, press  Tab  at the credential prompt to run  gh auth login  and sign in.

Choose a model (for example  gpt-5.5 ).
...
<div class="highlight highlight-source-dotenv notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="OPENWIKI_PROVIDER="copilot"

OPENWIKI_MODEL_ID="gpt-5.5"">  OPENWIKI_PROVIDER  =   " copilot "
...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="OPENWIKI_PROVIDER=bedrock
...
OPENWIKI_MODEL_ID=anthropic.claude-sonnet-5"> OPENWIKI_PROVIDER=bedrock
...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="OPENWIKI_PROVIDER=gemini

GEMINI_API_KEY=your-ai-studio-key"> OPENWIKI_PROVIDER=gemini
...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="OPENWIKI_PROVIDER=gemini-enterprise

GOOGLE_CLOUD_PROJECT=your-gcp-project

GOOGLE_CLOUD_LOCATION=global   # optional, defaults to global"> OPENWIKI_PROVIDER=gemini-enterprise
...
For CI, authenticate before the update job runs (for example with   google-github-actions/auth  ) and set  OPENWIKI_PROVIDER=gemini-enterprise  and  GOOGLE_CLOUD_PROJECT  in the job environment.
...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="OPENWIKI_PROVIDER=openai-chatgpt openwiki code --init

# or

OPENWIKI_PROVIDER=openai-chatgpt openwiki personal --init"> OPENWIKI_PROVIDER=openai-chatgpt openwiki code --init
...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="# Hosted gateway (for example Requesty, which fronts many upstream providers)
...
OPENWIKI_MODEL_ID=openai/gpt-5.5">   #  Hosted gateway (for example Requesty, which fronts many upstream providers)
...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="# Ollama, after `ollama serve` and `ollama pull llama3.2`
...
OPENWIKI_MODEL_ID=llama3.2">   #  Ollama, after `ollama serve` and `ollama pull llama3.2`
...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="# LM Studio, after starting the local server from the Developer tab
...
OPENWIKI_MODEL_ID=your-loaded-model-id">   #  LM Studio, after starting the local server from the Developer tab
...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="OPENWIKI_PROVIDER=anthropic

ANTHROPIC_API_KEY=your-key

ANTHROPIC_BASE_URL=https://your-gateway.example.com/anthropic"> OPENWIKI_PROVIDER=anthropic
...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="OPENWIKI_PROVIDER=openrouter

OPENROUTER_API_KEY=your-key

OPENWIKI_OPENROUTER_PROVIDER_ONLY=Novita"> OPENWIKI_PROVIDER=openrouter
...
Note  If there is an inference provider or model you would like to see added, please open a PR.
...
<div class="highlight highlight-source-gitignore notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="secrets/

*.log

!logs/keep.log">  secrets /
...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="openwiki                         # interactive chat, code mode, current repo
...
openwiki --help                  # full help"> openwiki                           #  interactive chat, code mode, current repo
...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto" data-snippet-clipboard-copy-content="export OPENWIKI_TELEMETRY_DISABLED=1

export DO_NOT_TRACK=1   # cross-tool standard">  export  OPENWIKI_TELEMETRY_DISABLED=1
...
About   OpenWiki is a CLI that writes and maintains agent documentation for your codebase.   Resources     Readme      MIT license     Code of conduct     Code of conduct     Contributing     Contributing     Security policy     Security policy      Activity      Custom properties     Stars     15.4k  stars    Watchers     39  watching    Forks      1.1k    forks      Report repository       Releases          Packages        Used by        Contributors        Languages
