...
- **Bitcoin (crypto)** — public dataset (blocks, transactions, inputs, outputs) from the `bitcoin-etl` pipeline. Exercises cross-table foreign-key relationships in prose. · [recipe](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/samples/stackoverflow/README.md) · [bundle](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/bundles/crypto_bitcoin) · [viz.html](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/bundles/crypto_bitcoin/viz.html)
