...
> 與 [[2026-02-10-pi-agent-core-design]] 為姊妹篇:**同一個專題的兩個視角**——A 篇解剖 `packages/agent/src/` 五支檔,B 篇俯瞰整個 monorepo。互不矛盾。
...
## 推導出的 wiki 頁
- Entities:[[pi-mono]]、[[pi-coding-agent]]、[[pi-ai]]、[[pi-tui]]、[[pi-web-ui]]
- Concepts:[[provider-abstraction]]
- Synthesis:[[minimal-agent-philosophy]]

## 相關頁面
- [[2026-02-10-pi-agent-core-design]] — 姊妹篇
- [[pi-agent-core]]
- [[pi-mono]]
