...
| `@mariozechner/pi-agent-core` | agent runtime | 文章 [[2026-02-10-pi-agent-core-design]] 重點解剖的對象;5 檔 / 1,500 行 |
...
→ 這是 [[2026-02-10-pi-agent-core-design]] 7.1 + [[2026-05-02-pi-mono-framework-tw]] 第 4 判斷的合併視角。
