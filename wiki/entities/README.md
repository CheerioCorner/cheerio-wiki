...
> Shared Wiki 的人、工具、package、服務與具體實作 entity collection。

- `type: entity` 的 canonical pages 放在本 collection。
- 自有 project 的進度、project-local decisions 與跨 session bundle 放在 root `projects/<project-id>/`。
