...
- **建立日期**：2026-07-11
- **最後更新**：2026-08-08（新增 HTML Slide Deck 製作工作流 concept + presentation skill）
...
- [[wiki/entities/README|Entities]] — 人、工具、package 與具體實作（含 [[wiki/entities/open-code-review|OpenCodeReview]] 19.3k ⭐、[[wiki/entities/learning-loop|Learning Loop]]、[[wiki/entities/markitdown|MarkItDown]] 172k ⭐、[[wiki/entities/obsidian|Obsidian]] 150 萬用戶）
